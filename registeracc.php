...
<script language="JavaScript" src="js/user.js">
  ...
  <center>  <img src="images/your_vote.png"></center>
   
<center><b><font color = "brown" size="6">Online Voting System</font></b></center><br><br>
<div id="page">
<div id="header">
<h1>Voter Registration </h1>
<div class="news"><marquee behavior="alternate"> Register Here by filling all the details and Click Login below to vote to your favourite Leader.  </marquee></div>
</div>
...
echo "<tr><td colspan = '2'><p>Already have an account? <a href='index.html'><b>Login Here</b></a></td></tr>";
echo "</tr></td></table>";
echo "</form>";
?>
</div> 
